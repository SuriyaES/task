            ...
            <div class = "invoice">
                <div class = "invoice-container">
                                ...
                                <tbody>
                                    ...
                                    while($row=mysqli_fetch_assoc($query1)) {
                                     ...
                                     ?><tr>
                                        ...
                                        <td><?php echo "Rs.".$row['price']; ?></td>
                                        <td class = "text-end"><?php echo "Rs.".$row['price']; ?></td></tr>
                                        <?php } ?>
                                </tbody>
                            </table>
                    ...
                    <div>
                        ...
                        ?>
                        <table>
                        <tr><td>Bank Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:     </td><td><?php echo $row['bank']; ?></td></tr>
                        <tr><td>Account Holder &nbsp;&nbsp;: </td><td><?php echo $row['account_holder']; ?></td></tr>
                        <tr><td>Account No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </td><td><?php echo $row['account_no']; ?></td></tr>
                        <tr><td>Branch Code&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </td><td><?php echo $row['branch_code']; ?></td></tr>
                        <tr><td>IFSC Code&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </td><td><?php echo $row['ifsc']; ?></td></tr>
                        </table>
                        <?php } ?>
                    </div>
                    </div>
